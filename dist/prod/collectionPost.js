...
const createtitle_1 = __importDefault(require("../utils/createtitle"));
/**
 * Обязательные
 * author_id: number;
 * course: number;
 ...
 * }
 */
function collectionPost(headers, body, firebase, collectionname) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const fb_id = yield firebase.set(collectionname, data);
            const metaCount = yield firebase.getCount('meta');
            const meta = yield firebase.get('meta', String(metaCount));
            const title = (0, createtitle_1.default)(data.course, data.semestr, data.subject, data.teacher);
            if (meta) {
...
exports.default = collectionPost;
